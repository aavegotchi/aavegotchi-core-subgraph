...
export function markWearableAsUnequipped(
  gotchiId: string,
  slotPosition: i32,
  wearableId: i32,
  timestamp: BigInt,
...
export function handleWearableEquipping(
  gotchiId: string,
  slotPosition: i32,
  wearableId: i32,
  owner: User,
...
export function handleWearableReplacing(
  gotchiId: string,
  slotPosition: i32,
  oldWearableId: i32,
  newWearableId: i32,
  ...
  // Mark old wearable as unequipped
