...
import { findOrCreateRolesRegistry, generateDepositId, updateRoleAssignmentExpiration } from '../../utils/helpers/erc-7589'
...
export function handleTokensReleased(event: TokensReleased): void {
  const tokenCommitmentId = generateDepositId(event.address.toHexString(), event.params._commitmentId)
